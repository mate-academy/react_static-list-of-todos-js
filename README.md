...
- Replace `Valentyna08` with your Github username in the [DEMO LINK](https://Valentyna08.github.io/react_static-list-of-todos-js/) and add it to the PR description.

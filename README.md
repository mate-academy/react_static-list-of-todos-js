...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://github.com/NataKovbasniuk/react_static-list-of-todos-js.git) and add it to the PR description.

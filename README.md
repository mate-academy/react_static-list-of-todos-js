...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://polinabs.github.io/react_static-list-of-todos-js/) and add it to the PR description.

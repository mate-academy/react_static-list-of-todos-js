...
- Replace `AntonBelia` with your Github username in the [DEMO LINK](https://AntonBelia.github.io/react_static-list-of-todos-js/) and add it to the PR description.

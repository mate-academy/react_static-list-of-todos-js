...
- Replace `<Fugas252mm>` with your Github username in the [DEMO LINK](https://github.com/Fugas252mm/react_static-list-of-todos-js.git) and add it to the PR description.

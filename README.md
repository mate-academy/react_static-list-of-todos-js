...
- Replace `andriy-chornyy` with your Github username in the [DEMO LINK](https://andriy-chornyy.github.io/react_static-list-of-todos-js/) and add it to the PR description.

...
- Implement a solution following the [React task guideline](httpgit s://github.com/mate-academy/react_task-guideline#react-tasks-guideline).
- Open one more terminal and run tests with `npm test` to ensure your solution is correct.
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://<jasialazyrka>.github.io/react_static-list-of-todos-js/) and add it to the PR description.
